...
func _set_shader_f_value(name_value, value):
  self.shader_meterial.set_shader_parameter(name_value, value)

func _set_shader_color_value(name_value, color):
  self.shader_meterial.set_shader_parameter(name_value, color)

func _set_shader_texture_value(name_value, texture):
  self.shader_meterial.set_shader_parameter(name_value, texture)
